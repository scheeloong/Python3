...
# This is the example file for waterjugs problem that has been implemented in full
# Use this to implement eightPuzzle 

from search import *

# This is a class that is a child of StateSpace
class WaterJugs(StateSpace):

    StateSpace.n = 0
    
    #override actual constructor
    def __init__(self, action, f, gal3, gal4, parent = None):
        # calls parent constructor 
        StateSpace.__init__(self, action, gval, parent)
        self.gal3 = gal3
        self.gal4 = gal4
        
    # This overwrites parent's successor() method 
    def successors(self):
        ...
        transtion."""
        # Initialize a new list of actions that can be taken called states
        # and start appending depending on what is available 
        States = list()
        if self.gal3 > 0 : # only execute this action if gallon 3 is not empty 
    ...
    # To know which state, return the amount in gal3 and amount in gal 4    
    # This is used to prevent cycles in cycle checking function
    # Therefore, each state must have it's own unique hashable_state. 
    ...
    def print_state(self):
        ...
        # Otherwise, print this stae stating it is the initial state 
        else:
...
# Only execute below if this file is the main function 
if __name__ == "__main__":

    print('New Execution') 
    #sample runs 
    # Create a new Search Engine Object 
    # with strategy to use as astar search and
    # cycle checking to be full 
    ...
    # Set the goal to be 0 in Gallon 3, and 1 in Gallon 4 
    s0 = WaterJugs("START", 0, 0, 0)
    waterjugs_set_goal(0, 1)
    
    # But above is redundant since you ovewrite it with 
    # set final Goal to be 2 in Gallon3 and 0 in Gallon 4 
